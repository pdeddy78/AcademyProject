package com.example.latihan.pdeddy78.academy.ui.bookmark;
...
import com.example.latihan.pdeddy78.academy.ui.detail.DetailCourseActivity;
...
public class BookmarkAdapter extends RecyclerView.Adapter<BookmarkAdapter.AcademyViewHolder> {
    ...
    public void setListCourses(List<CourseEntity> listCourses) {
        ...
        this.courses.clear();
        this.courses.addAll(listCourses);
    }
